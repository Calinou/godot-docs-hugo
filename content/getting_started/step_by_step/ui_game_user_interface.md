Design the GUI {#doc_ui_game_user_interface}
==============
...
![The Number node aligned to the left and
...
A scene is a tree of nodes. The topmost node is the tree\'s **root**,
...
![Now both counters have a decent
