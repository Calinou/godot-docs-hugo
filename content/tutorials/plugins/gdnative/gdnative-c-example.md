GDNative C example {#doc_gdnative_c_example}
==================
...
Now, it\'s time to start working on the functions of our object. First,
...
*Reloadable* defines whether the library should be reloaded when the
