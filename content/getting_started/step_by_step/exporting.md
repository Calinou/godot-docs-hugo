...
Next, we need to modify the `Player.gd` script to change the input
...
The second button, \"Export Project\", creates a complete executable
...
In order to build your game for iOS, you must have a computer running
